...
Please refer to [this page](https://https://docs.openvinotoolkit.org/2020.1/_docs_install_guides_installing_openvino_windows.html) for more information about how to install and setup the Intel® Distribution of OpenVINO™ Toolkit for Windows 10.

You can follow this setup below if you are using a different version of Windows:
...
If you have additional questions specific to using WSL, please see the FAQ [here](https://docs.microsoft.com/en-us/windows/wsl/faq).
